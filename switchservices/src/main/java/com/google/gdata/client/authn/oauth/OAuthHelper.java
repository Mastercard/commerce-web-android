...
public class OAuthHelper {
   ...
   */
  @Deprecated public OAuthHelper(String requestTokenUrl, String userAuthorizationUrl,
  ...
  public OAuthHelper(String requestTokenUrl, String userAuthorizationUrl, String accessTokenUrl,
      String revokeTokenUrl, OAuthSigner signer) {
    this(requestTokenUrl, userAuthorizationUrl, accessTokenUrl, revokeTokenUrl, signer,
        new OAuthHttpClient());
  }
   ...
   */
  public OAuthHelper(String requestTokenUrl, String userAuthorizationUrl, String accessTokenUrl,
      String revokeTokenUrl, OAuthSigner signer, OAuthHttpClient httpClient) {
    this.requestTokenUrl = requestTokenUrl;
    this.userAuthorizationUrl = userAuthorizationUrl;
    this.accessTokenUrl = accessTokenUrl;
  ...
  public void getUnauthorizedRequestToken(OAuthParameters oauthParameters) throws OAuthException {
    TwoLeggedOAuthHelper helper = new TwoLeggedOAuthHelper(signer, oauthParameters);
    ...
    if (oauthParameters.checkOAuthCallbackExists()) {
      ...
      oauthParameters.addCustomBaseParameter(OAuthParameters.OAUTH_CALLBACK_KEY, callback);
   ...
   */
  @Deprecated public String getUserAuthorizationUrl(OAuthParameters oauthParameters)
  ...
  public String createUserAuthorizationUrl(OAuthParameters oauthParameters) {
    ...
    return (new StringBuilder()).append(userAuthorizationUrl)
        .append("?")
        .append(queryParams.toString())
        .toString();
  }
  ...
  public void getOAuthParametersFromCallback(String queryString, OAuthParameters oauthParameters) {
    ...
    if (params.get(OAuthParameters.OAUTH_TOKEN_SECRET_KEY) != null) {
      oauthParameters.setOAuthTokenSecret(params.get(OAuthParameters.OAUTH_TOKEN_SECRET_KEY));
    }
    if (params.get(OAuthParameters.OAUTH_VERIFIER_KEY) != null) {
      oauthParameters.setOAuthVerifier(params.get(OAuthParameters.OAUTH_VERIFIER_KEY));
    }
  }
  ...
  public void revokeToken(OAuthParameters oauthParameters) throws OAuthException {
    ...
    headers.put("Authorization", getAuthorizationHeader(revokeTokenUrl, "GET", oauthParameters));
  ...
  static abstract class KeyValuePair {
     ...
     */
    protected KeyValuePair(String keyValueStartDelimiter, String keyValueEndDelimiter,
    ...
    @Override public String toString() {
      ...
      for (int i = 0, length = size(); i < length; i++) {
        ...
        keyValueString.append(OAuthUtil.encode(getKey(i)))
            ...
            .append(OAuthUtil.encode(getValue(i)))
