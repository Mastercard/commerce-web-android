...
public class OAuthUtil {
   ...
   * String</a>
   */
  public static String getSignatureBaseString(String requestUrl, String httpMethod,
      Map<String, String> baseParameters) throws OAuthException {
    return encode(httpMethod.toUpperCase()) + '&' + encode(normalizeUrl(requestUrl)) + '&' + encode(
        normalizeParameters(requestUrl, baseParameters));
  }
  ...
  public static String normalizeUrl(String requestUrl) throws OAuthException {
    ...
    if ((scheme.equals("http") && uri.getPort() == 80) || (scheme.equals("https")
        && uri.getPort() == 443)) {
  ...
  public static String normalizeParameters(String requestUrl,
    ...
    for (Map.Entry<String, String> e : alphaParams.entrySet()) {
      ...
      paramString.append(encode(e.getKey())).append("=").append(encode(e.getValue()));
    }
  ...
  public static String encode(String stringToEncode) {
    return CharEscapers.uriEscaper()
