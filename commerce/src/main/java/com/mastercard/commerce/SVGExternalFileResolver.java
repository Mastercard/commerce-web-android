 ...
 * <p>
 * Extend this class and override the methods if you want to customise how AndroidSVG treats font
 * and image references.
 */

abstract class SVGExternalFileResolver {
  /**
   ...
   * them cached, for speed or memory reasons, you should do so yourself.
   *
   * @param filename the filename as provided in the xlink:href attribute of a &lt;image&gt;
   * element.
