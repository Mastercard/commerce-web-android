...
class SVGParser extends DefaultHandler2 {
  ...
  private enum SVGAttr {
    ...
    clip, clip_path, clipPathUnits, clip_rule, color, cx, cy, direction, dx, dy, fx, fy, d, display, fill, fill_rule, fill_opacity, font, font_family, font_size, font_weight, font_style, // font_size_adjust, font_stretch, font_variant,
  ...
  private static HashMap<String, SVG.Length> fontSizeKeywords = new HashMap<String, SVG.Length>(9);
  ...
  private static HashMap<String, SVG.Style.FontStyle> fontStyleKeywords =
      new HashMap<String, SVG.Style.FontStyle>(3);
  private static HashMap<String, PreserveAspectRatio.Alignment> aspectRatioKeywords =
      new HashMap<String, PreserveAspectRatio.Alignment>();
  static HashSet<String> supportedFeatures = new HashSet<String>();
  ...
  @Override public void characters(char[] ch, int start, int length) throws SAXException {
    ...
    if (currentElement instanceof SVG.TextContainer) {
      ...
      SVG.SvgObject previousSibling =
          (numOlderSiblings == 0) ? null : parent.children.get(numOlderSiblings - 1);
      if (previousSibling instanceof SVG.TextSequence) {
        ...
        ((SVG.SvgConditionalContainer) currentElement).addChild(
            new SVG.TextSequence(new String(ch, start, length)));
      }
    }
  }
  ...
  @Override public void endDocument() throws SAXException {
    ...
    // Dump document
    if (false) dumpNode(svgDocument.getRootElement(), "");
  }
  ...
  private void parseAttributesTextPosition(SVG.TextPositionedContainer obj, Attributes attributes)
      throws SAXException {
    for (int i = 0; i < attributes.getLength(); i++) {
      String val = attributes.getValue(i).trim();
      switch (SVGAttr.fromString(attributes.getLocalName(i))) {
    ...
    for (int i = 0; i < attributes.getLength(); i++) {
      ...
      switch (SVGAttr.fromString(attributes.getLocalName(i))) {
        ...
        case requiredFonts:
          ...
          Set<String> fontSet =
              (fonts != null) ? new HashSet<String>(fonts) : new HashSet<String>(0);
      ...
      switch (SVGAttr.fromString(attributes.getLocalName(i))) {
        ...
        case spreadMethod:
          try {
            ...
            throw new SAXException(
                "Invalid spreadMethod attribute. \"" + val + "\" is not a valid value.");
          }
          break;
        case href:
          if (!XLINK_NAMESPACE.equals(attributes.getURI(i))) break;
  ...
  static class TextScanner {
    ...
    public boolean consume(String str) {
      int len = str.length();
      boolean found =
          (position <= (input.length() - len) && input.substring(position, position + len)
              .equals(str));
    ...
    public String nextFunction() {
      ...
      int ch = input.charAt(position);
      while ((ch >= 'a' && ch <= 'z') || (ch >= 'A' && ch <= 'Z')) ch = advanceChar();
      int end = position;
    ...
    public String ahead() {
      int start = position;
      while (!empty() && !isWhitespace(input.charAt(position))) position++;
    ...
    public SVG.Unit nextUnit() {
      ...
      try {
        SVG.Unit result =
            SVG.Unit.valueOf(input.substring(position, position + 2).toLowerCase(Locale.US));
        position += 2;
        return result;
      } catch (IllegalArgumentException e) {
        return null;
    ...
    public String nextQuotedString() {
      ...
      ch = advanceChar();
      while (ch != -1 && ch != endQuote) ch = advanceChar();
      if (ch == -1) {
        position = start;
        return null;
      }
  ...
  private void parseAttributesCore(SVG.SvgElementBase obj, Attributes attributes)
      throws SAXException {
    for (int i = 0; i < attributes.getLength(); i++) {
  ...
  /*
    ...
    */
  private void parseAttributesStyle(SVG.SvgElementBase obj, Attributes attributes)
      throws SAXException {
    for (int i = 0; i < attributes.getLength(); i++) {
      String val = attributes.getValue(i).trim();
      ...
      switch (SVGAttr.fromString(attributes.getLocalName(i))) {
        ...
        default:
          if (obj.baseStyle == null) obj.baseStyle = new SVG.Style();
  ...
  private static void parseStyle(SVG.SvgElementBase obj, String style) throws SAXException {
    TextScanner scan =
        new TextScanner(style.replaceAll("/\\*.*?\\*/", ""));  // regex strips block comments
    ...
    while (true) {
      ...
      if (scan.empty() || scan.consume(';')) {
        if (obj.style == null) obj.style = new SVG.Style();
  ...
  static void processStyleProperty(SVG.Style style, String localName, String val)
    ...
    switch (SVGAttr.fromString(localName)) {
      ...
      case marker:
        ...
        style.specifiedFlags |=
            (SVG.SPECIFIED_MARKER_START | SVG.SPECIFIED_MARKER_MID | SVG.SPECIFIED_MARKER_END);
        break;
  ...
  /*
    ...
    */
  private static SVG.Length parseLength(String val) throws SAXException {
  ...
  private static SVG.Style.TextDecoration parseTextDecoration(String val) throws SAXException {
    if ("none".equals(val)) return SVG.Style.TextDecoration.None;
    if ("underline".equals(val)) return SVG.Style.TextDecoration.Underline;
    if ("overline".equals(val)) return SVG.Style.TextDecoration.Overline;
    if ("line-through".equals(val)) return SVG.Style.TextDecoration.LineThrough;
    if ("blink".equals(val)) return SVG.Style.TextDecoration.Blink;
  ...
  private static SVG.Style.TextDirection parseTextDirection(String val) throws SAXException {
    if ("ltr".equals(val)) return SVG.Style.TextDirection.LTR;
    if ("rtl".equals(val)) return SVG.Style.TextDirection.RTL;
  ...
  private static SVG.Style.FillRule parseFillRule(String val) throws SAXException {
    if ("nonzero".equals(val)) return SVG.Style.FillRule.NonZero;
    if ("evenodd".equals(val)) return SVG.Style.FillRule.EvenOdd;
  ...
  private static SVG.Style.LineCaps parseStrokeLineCap(String val) throws SAXException {
    if ("butt".equals(val)) return SVG.Style.LineCaps.Butt;
    if ("round".equals(val)) return SVG.Style.LineCaps.Round;
    if ("square".equals(val)) return SVG.Style.LineCaps.Square;
  ...
  private static SVG.Style.LineJoin parseStrokeLineJoin(String val) throws SAXException {
    if ("miter".equals(val)) return SVG.Style.LineJoin.Miter;
    if ("round".equals(val)) return SVG.Style.LineJoin.Round;
    if ("bevel".equals(val)) return SVG.Style.LineJoin.Bevel;
  ...
  private static SVG.Style.TextAnchor parseTextAnchor(String val) throws SAXException {
    if ("start".equals(val)) return SVG.Style.TextAnchor.Start;
    if ("middle".equals(val)) return SVG.Style.TextAnchor.Middle;
    if ("end".equals(val)) return SVG.Style.TextAnchor.End;
  ...
  private static SVG.Length parseLengthOrAuto(TextScanner scan) {
    if (scan.consume("auto")) return new SVG.Length(0f);
  ...
  private static SVG.Style.VectorEffect parseVectorEffect(String val) throws SAXException {
    if ("none".equals(val)) return SVG.Style.VectorEffect.None;
    if ("non-scaling-stroke".equals(val)) return SVG.Style.VectorEffect.NonScalingStroke;
