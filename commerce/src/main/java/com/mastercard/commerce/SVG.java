...
class SVG {
   ...
   */
  static SVG getFromInputStream(InputStream is) throws SVGParseException {
   ...
   */
  private Picture renderToPicture(int widthInPixels, int heightInPixels) {
  ...
  static class SvgConditionalElement extends SvgElement implements SvgConditional {
    ...
    @Override public void setRequiredFeatures(Set<String> features) {
      this.requiredFeatures = features;
    }

    @Override public Set<String> getRequiredFeatures() {
      return this.requiredFeatures;
    }

    @Override public void setRequiredExtensions(String extensions) {
      this.requiredExtensions = extensions;
    }

    @Override public String getRequiredExtensions() {
      return this.requiredExtensions;
    }

    @Override public void setSystemLanguage(Set<String> languages) {
      this.systemLanguage = languages;
    }

    @Override public Set<String> getSystemLanguage() {
      return this.systemLanguage;
    }

    @Override public void setRequiredFormats(Set<String> mimeTypes) {
      this.requiredFormats = mimeTypes;
    }

    @Override public Set<String> getRequiredFormats() {
      return this.requiredFormats;
    }

    @Override public void setRequiredFonts(Set<String> fontNames) {
      this.requiredFonts = fontNames;
    }

    @Override public Set<String> getRequiredFonts() {
  ...
  static class SvgConditionalContainer extends SvgElement
    ...
    @Override public List<SvgObject> getChildren() {
      return children;
    }

    @Override public void addChild(SvgObject elem) throws SAXException {
      children.add(elem);
    }
  ...
  static class Group extends SvgConditionalContainer implements HasTransform {
    ...
    @Override public void setTransform(Matrix transform) {
  ...
  static abstract class GraphicsElement extends SvgConditionalElement
  ...
  static class TSpan extends TextPositionedContainer implements TextChild {
    ...
    @Override public void setTextRoot(TextRoot obj) {
      this.textRoot = obj;
    }

    @Override public TextRoot getTextRoot() {
  ...
  static class Stop extends SvgElementBase implements SvgContainer {
    ...
    @Override public void addChild(SvgObject elem) throws SAXException { /* do nothing */ }
  }
  ...
  interface PathInterface {
    ...
    void arcTo(float rx, float ry, float xAxisRotation, boolean largeArcFlag, boolean sweepFlag,
        float x, float y);
      ...
      for (byte command : commands) {
        switch (command) {
          ...
          case LINETO:
            ...
            break;
          case CUBICTO:
            handler.cubicTo(coordsIter.next(), coordsIter.next(), coordsIter.next(),
                coordsIter.next(), coordsIter.next(), coordsIter.next());
            break;
          case QUADTO:
            handler.quadTo(coordsIter.next(), coordsIter.next(), coordsIter.next(),
                coordsIter.next());
            break;
          case CLOSE:
            handler.close();
          ...
          default:
            ...
            handler.arcTo(coordsIter.next(), coordsIter.next(), coordsIter.next(), largeArcFlag,
                sweepFlag, coordsIter.next(), coordsIter.next());
        }
      }
    }
  }
