...
public class CartFragment extends Fragment
        implements CartListView, MasterpassUICallback {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mAdapter = new CartAdapter(getActivity(), new ArrayList<Item>(0),
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        tvCheckoutBottom.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //showConfirmationPairingScreen();
                mPresenter.loadConfirmation(null, true);
    ...
    @Override
    public void showMasterpassButton(Button masterpassButton) {
        buttonVisible = true;
    ...
    @Override
    public void hideMasterpassButton() {
        llButtonMasterpass.setVisibility(View.INVISIBLE);
    }

    @Override
    public void masterpassSdkInitialized() {
        mPresenter.showMasterpassButton();
    }
    ...
    @Override
    public void showConfirmationPairingScreen(MasterpassConfirmationObject masterpassPreCheckoutConfirmationObject) {
        showLoadingSpinner(false);
        ...
        Bundle bundle = new Bundle();
        bundle.putSerializable(PresentationConstants.KEY_DATA_CONFIRMATION, masterpassPreCheckoutConfirmationObject);
        bundle.putBoolean(PresentationConstants.KEY_DATA_SUPRESS_SHIPPING, suppressShipping);
        CartConfirmationPairingFragment cartConfirmationPairingFragment = new CartConfirmationPairingFragment();
        cartConfirmationPairingFragment.setArguments(bundle);

        CartConfirmationPresenter mCartConfirmationPresenter = new CartConfirmationPresenter(
                UseCaseHandler.getInstance(),
                cartConfirmationPairingFragment,
                new GetItemsOnCartUseCase(ItemRepository.getInstance(ItemExternalDataSource.getInstance(),
                        ItemLocalDataSource.getInstance(this.getContext()))),
                new CompleteTransactionUseCase(MasterpassExternalDataSource.getInstance(),
                        this.getContext()),
    ...
    @Override
    public void onSDKCheckoutError() {
