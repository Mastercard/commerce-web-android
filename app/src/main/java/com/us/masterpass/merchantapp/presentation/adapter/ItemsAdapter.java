...
public class ItemsAdapter extends BaseAdapter {
     ...
     */
    public ItemsAdapter(Context context, List<Item> item,
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        viewHolder.priceTV.setText("$" + Double.toString(item.getPrice()));
        viewHolder.salePriceTV.setText("$" + Double.toString(item.getSalePrice()));
