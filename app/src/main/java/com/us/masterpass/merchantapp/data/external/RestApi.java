...
public class RestApi {
     ...
     */
    public String getDataConfirmation(Map<String, Object> checkoutData, boolean expressCheckoutEnable) {
        String response = null;
        try {
    ...
    private String getDataConfirmationFromApi(Map<String, Object> checkoutData, boolean expressCheckoutEnable) throws MalformedURLException {
    ...
    private String getPairingIdFromApi(Map<String, Object> checkoutData) throws MalformedURLException {
