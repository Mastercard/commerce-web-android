 ...
 */
public class GetSettingsUseCase extends UseCase<GetSettingsUseCase.RequestValues, GetSettingsUseCase.ResponseValue> {
    ...
    protected void executeUseCase(final RequestValues values) {
        ResponseValue responseValue = new ResponseValue(
                SettingsListOptions.settingsList(mContext),
