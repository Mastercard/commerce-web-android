...
*/
/**
 * Created by akhildixit on 11/6/17.
 *//*

@RunWith(AndroidJUnit4.class)
@FixMethodOrder(MethodSorters.NAME_ASCENDING)
public class MerchantApplicationScreengrab {
...
//    public static final LocaleTestRule localeTestRule = new LocaleTestRule();
    ...
    public void testDAppWithSuppress() throws Exception {
        ...
        Screengrab.screenshot("21");
        onView(withId(R.id.cart_confirm_btn)).
                check(matches(isDisplayed())).
                perform(click());
        Thread.sleep(2000);
        onView(withText("SHIP TO")).check(matches(not(isDisplayed())));
        Screengrab.screenshot("22");
        onView(withId(R.id.cart_complete_btn)).
                check(matches(isDisplayed())).
                perform(click());
        Thread.sleep(2000);
