...
public class SettingsDetailPaymentFragment extends Fragment
  ...
  static final int LOGIN_REQUEST = 1;
    ...
    @Override
    public void showSettingDetail(List<SettingsVO> settings) {
    }

    @Override
    public void showSettingDetail(boolean isLogged, boolean hasPairingId) {
    ...
    @Override
    public void enableButtonMasterpassPayment() {
  ...
  @Override
    public void updateCheckBox(boolean enable) {
        mPaymentMasterpassCB.setChecked(enable);
        hasPairingId = enable;
    }

    @Override
    public void setPresenter(SettingsDetailPaymentPresenter presenter) {
