...
/**
 * Created by Sebastian Farias on 20-10-17.
 */
public class SettingsConstants {
  ...
  /**
   * The constant ITEM_ENABLE_PAYMENT_METHOD.
   */
  public static final String ITEM_ENABLE_PAYMENT_METHOD = "ENABLE PAYMENT METHOD";
  /**
   * The constant ITEM_DSRP.
   */
  public static final String ITEM_DSRP = "TOKENIZATION";
  /**
   * The constant ITEM_PAYMENT_METHOD.
   */
  public static final String ITEM_PAYMENT_METHOD = "PAYMENT METHODS";

  /**
   * The constant TITLE_DSRP.
   */
  public static final String TITLE_DSRP = "Tokenization";

  /**
   * The constant CARD_AMERICAN.
   */
  public static final String CARD_AMERICAN = "American";
  /**
   * The constant CARD_DISCOVER.
   */
  public static final String CARD_DISCOVER = "Discover";
  /**
   * The constant CARD_JCB.
   */
  public static final String CARD_JCB = "JCB";
  /**
   * The constant CARD_MASTERCARD.
   */
  public static final String CARD_MASTERCARD = "MasterCard";
  /**
   * The constant CARD_MESTRO.
   */
  public static final String CARD_MESTRO = "Maestro";

  /**
   * The constant CARD_DINERS.
   */
  public static final String CARD_DINERS = "Diners";

  /**
   * The constant CARD_VISA.
   */
