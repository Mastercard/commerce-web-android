...
public class SettingsConstants {
  ...
  public enum SDK_LANG {
    ...
    ENGLISH("English(UK)", "en_GB"), ENGLISH_IN("English(IN)", "en_IN"), ENGLISH_US("English(US)", "en_US"),
    PORTUGUESE("Portuguese(BR)", "pt_BR"), SPANISH("Spanish(MX)", "es_MX"), FRENCH("French(CA)", "fr_CA"),
    ENGLISH_CA("English(CA)", "en_CA"), ENGLISH_TH("English(TH)", "en_TH"), SPANISH_AR("Spanish(AR)", "es_AR"),
    SPANISH_CO("Spanish(CO)", "es_CO"), ENGLISH_HK("English(HK)", "en_HK"), ENGLISH_SG("English(SG)", "en_SG"),
    ENGLISH_PH("English(PH)", "en_PH"), ENGLISH_MY("English(MY)", "en_MY"), ENGLISH_AU ("English(AU)", "en_AU"),
    ENGLISH_NZ("English(NZ)", "en_NZ");
