...
public class CartConfirmationPairingFragment extends Fragment
   ...
   */
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
      ...
      mViewPager.setAdapter(cartConfirmationPairingAdapter);
        ...
        for (int i = 0; i < cardVPDotsCount; i++) {
            ...
            cardVPDots[i].setImageDrawable(ContextCompat.getDrawable(getContext(), R.drawable.viewpager_selector_inactive));
            LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(LinearLayout.LayoutParams.WRAP_CONTENT, LinearLayout.LayoutParams.WRAP_CONTENT);
            params.setMargins(8, 0, 8, 0);
            viewpageDotsLl.addView(cardVPDots[i], params);
        }
        cardVPDots[0].setImageDrawable(ContextCompat.getDrawable(getContext(), R.drawable.viewpager_selector_active));
      ...
      mViewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                ...
                cardVPDots[position].setImageDrawable(ContextCompat.getDrawable(getContext(), R.drawable.viewpager_selector_active));
      ...
      if(!masterpassConfirmationObject.getListPreCheckoutShipping().isEmpty()) {
        CartConfirmationPairingAddressAdapter cartConfirmationPairingAddressAdapter =
            new CartConfirmationPairingAddressAdapter(getContext(), masterpassConfirmationObject.getListPreCheckoutShipping());
        ...
        for (int i = 0; i < addressVPDotsCount; i++) {
          ...
          addressVPDots[i].setImageDrawable(ContextCompat.getDrawable(getContext(), R.drawable.viewpager_selector_inactive));
          LinearLayout.LayoutParams params =
              new LinearLayout.LayoutParams(LinearLayout.LayoutParams.WRAP_CONTENT, LinearLayout.LayoutParams.WRAP_CONTENT);
          params.setMargins(8, 0, 8, 0);
          viewpageAddressDotsLl.addView(addressVPDots[i], params);
        }
        addressVPDots[0].setImageDrawable(ContextCompat.getDrawable(getContext(), R.drawable.viewpager_selector_active));
        ...
        mViewPagerAddress.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
          ...
          @Override public void onPageSelected(int position) {
            ...
            addressVPDots[position].setImageDrawable(ContextCompat.getDrawable(getContext(), R.drawable.viewpager_selector_active));
            masterpassConfirmationObject.setDoCheckoutShippingAddressId(masterpassConfirmationObject
                .getListPreCheckoutShipping()
                .get(position)
                .getPreAddressId());
          }
    ...
    public void showCompleteScreen(MasterpassConfirmationObject masterpassConfirmationObject) {
      ...
      FragmentManager fm = getActivity().getSupportFragmentManager();
        ...
        CartConfirmationPresenter mCartConfirmationPresenter = new CartConfirmationPresenter(
                UseCaseHandler.getInstance(),
                cartConfirmationFragment,
  ...
  ExpressCheckoutRequest getMasterpassExpressCheckoutObject(
    ...
    return new ExpressCheckoutRequest.Builder().setAmount(
        ...
        .setShippingAddressId(isShippingEnabled ?
            masterpassConfirmationObject.getListPreCheckoutShipping().get(mViewPagerAddress.getCurrentItem()).getPreAddressId():null)
