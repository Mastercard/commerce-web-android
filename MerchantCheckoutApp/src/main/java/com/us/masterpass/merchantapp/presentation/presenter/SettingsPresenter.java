...
public class SettingsPresenter implements SettingsPresenterInterface {
  ...
  private SettingsListView mSettingsListView;
    ...
    public SettingsPresenter(@NonNull UseCaseHandler useCaseHandler,
                             @NonNull SettingsListView settingsListView,
    ...
    public void loadSettings() {
        mUseCaseHandler.execute(mGetSettings,
                new GetSettingsUseCase.RequestValues(),
                new UseCase.UseCaseCallback<GetSettingsUseCase.ResponseValue>() {
                    @Override
                    public void onSuccess(GetSettingsUseCase.ResponseValue response) {
  ...
  public void getPairingId(HashMap<String, Object> checkoutData) {
    if (checkoutData.get(PAIRING_TRANSACTION_ID) != null) {
      MasterpassSdkCoordinator.savePairingTransactionId(checkoutData.get(PAIRING_TRANSACTION_ID).toString());
