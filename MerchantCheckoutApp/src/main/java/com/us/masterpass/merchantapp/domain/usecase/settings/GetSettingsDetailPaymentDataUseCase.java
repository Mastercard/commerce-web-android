 ...
 */
public class GetSettingsDetailPaymentDataUseCase
        extends UseCase<GetSettingsDetailPaymentDataUseCase.RequestValues, GetSettingsDetailPaymentDataUseCase.ResponseValue> {
     ...
     */
    public GetSettingsDetailPaymentDataUseCase(@NonNull SettingsSaveConfigurationSdk settingsSaveConfigurationSdk) {
    ...
    protected void executeUseCase(final RequestValues values) {
        ...
        ResponseValue responseValue = new ResponseValue(
                mSettingsSaveConfigurationSdk.getIsLogged(),
                hasPairing
        );
