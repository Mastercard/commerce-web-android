 ...
 *
 * Remove item from specific object on local data
 */
public class RemoveItemUseCase  extends UseCase<RemoveItemUseCase.RequestValues, RemoveItemUseCase.ResponseValue> {
    private final ItemRepository mItemsRepository;

    /**
     * Instantiates a new Remove item use case.
     *
     * @param tasksRepository the tasks repository
     */
    public RemoveItemUseCase(@NonNull ItemRepository tasksRepository) {
    ...
    protected void executeUseCase(final RequestValues values) {
        ...
        mItemsRepository.removeItem(item, new ItemDataSource.GetItemOnCartCallback() {
            @Override
            public void onItemOnCart(String totalItem, List<Item> newItemOnCart, List<CartLocalObject> itemsOnCart) {
                ...
                ResponseValue responseValue = new ResponseValue(totalItem,
                        newItemOnCartFinal ,
                        itemsOnCart,
                        "$" + totalSalePriceText,
                        "$" + taxText,
