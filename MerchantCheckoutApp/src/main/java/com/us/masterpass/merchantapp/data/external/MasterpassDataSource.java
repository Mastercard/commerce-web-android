...
public interface MasterpassDataSource {
     ...
     */
    void getDataConfirmation(Map<String, Object> checkoutData,
    ...
    void doLogin(String username,
        String password,
        LoadDataLoginCallback callback);
     ...
     */
    void getPairingId(Map<String, Object> checkoutData,
        PairingIdCallback callback);
