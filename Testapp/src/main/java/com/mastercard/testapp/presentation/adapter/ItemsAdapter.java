...
public class ItemsAdapter extends BaseAdapter {
  ...
  @Override public View getView(int i, View view, ViewGroup viewGroup) {
    ...
    viewHolder.priceTV.setText(
        SettingsListOptions.getCurrencySymbol(context) + Double.toString(item.getPrice()));
    viewHolder.salePriceTV.setText(
        SettingsListOptions.getCurrencySymbol(context) + Double.toString(item.getSalePrice()));
