 ...
 * <p>
 * Object used on checkout confirmation
 */
public class MasterpassConfirmationObject implements Serializable {
  ...
  private String shippingSubDivision;
  ...
  private List<MasterpassPreCheckoutCardObject> listMasterpassPreCheckoutCardObject;
   ...
   */
  public List<MasterpassPreCheckoutCardObject> getListMasterpassPreCheckoutCardObject() {
    return listMasterpassPreCheckoutCardObject;
  }

  /**
   * Sets list pre checkout card.
   *
   * @param listMasterpassPreCheckoutCardObject the list pre checkout card
   */
  public void setListMasterpassPreCheckoutCardObject(
      List<MasterpassPreCheckoutCardObject> listMasterpassPreCheckoutCardObject) {
    this.listMasterpassPreCheckoutCardObject = listMasterpassPreCheckoutCardObject;
  }
   ...
   */
  public void setListPreCheckoutShipping(
      List<MasterpassPreCheckoutShippingObject> listPreCheckoutShipping) {
  ...
  /**
   * Is do checkout suppress shipping boolean.
   *
   * @return the boolean
   */
  ...
  /**
   * Sets do checkout suppress shipping.
   *
   * @param doCheckoutSupressShipping the do checkout suppress shipping
   */
  ...
  public String getShippingSubDivision() {
    return shippingSubDivision;
  }

  public void setShippingSubDivision(String shippingSubDivision) {
