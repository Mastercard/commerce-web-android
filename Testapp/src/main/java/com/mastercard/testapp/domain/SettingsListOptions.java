...
public class SettingsListOptions {
  ...
  public static List<SettingsVO> settingsList(Context context) {
    ...
    enablePaymentMethodOption.setSelected(SettingsSaveConfigurationSdk.getInstance(context)
   ...
   * @param settingsSavedConfigSdk the settings saved config sdk {@link
  ...
  private static void saveCards(SettingsSaveConfigurationSdk settingsSaveConfigurationSdk,
      SettingsSaveInterface.SaveItemsCallback callback, Set<String> configToSaveStringSet) {
  ...
  private static void saveSwitchSettings(SettingsSaveConfigurationSdk settingsSaveConfigurationSdk,
    ...
    if (settingsSwitch.getName().equalsIgnoreCase(SettingsConstants.ITEM_SUPRESS)
      ...
      callback.onSettingsSaved();
        ...
        && settingsSaveConfigurationSdk.settingsSave(SettingsSaveConstants.SDK_CONFIG_MASTERPASS,
        settingsSwitch.isSelected())) {
      if (!settingsSwitch.isSelected()) {
      ...
      if (settingsSaveConfigurationSdk.getIsLogged() && settingsSaveConfigurationSdk.settingsSave(
          SettingsSaveConstants.SDK_CONFIG_EXPRESS, settingsSwitch.isSelected())) {
        callback.onSettingsSaved();
      } else {
        callback.onSettingsNotSaved();
      }
    } else if (settingsSwitch.getName().equalsIgnoreCase(SettingsConstants.ENABLE_WEB_CHECKOUT)
        && settingsSaveConfigurationSdk.settingsSave(SettingsSaveConstants.SDK_WEB_CHECKOUT,
        settingsSwitch.isSelected())) {
      settingsSaveConfigurationSdk.settingsSave(SettingsSaveConstants.SDK_PAYMENT_METHOD, false);
      callback.onSettingsSaved();
    } else if (settingsSwitch.getName().equalsIgnoreCase(SettingsConstants.ITEM_PAYMENT_METHOD)
        && settingsSaveConfigurationSdk.settingsSave(SettingsSaveConstants.SDK_PAYMENT_METHOD,
        settingsSwitch.isSelected())) {
      ...
      callback.onSettingsSaved();
        ...
        && settingsSaveConfigurationSdk.settingsSave(SettingsSaveConstants.SDK_SUPRESS_3DS,
        settingsSwitch.isSelected())) {
      callback.onSettingsSaved();
    }
  }
  ...
  public static String getCountryCode(Context context) {
    ...
    if (countryConfig != null) {
      ...
      if (arr > 1) return countryConfig.split("_")[1];
    }
    return null;
  }
  ...
  public static String getCurrenyNumber(Context context) {
    SettingsConstants.SDK_CURRENCY sdkCurrency =
        getSDKCurrency(getConfigString(context, SettingsSaveConstants.SDK_CONFIG_CURRENCY));
    if (sdkCurrency != null) {
